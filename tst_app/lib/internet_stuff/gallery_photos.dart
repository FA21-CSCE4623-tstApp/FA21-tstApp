...
class GalleryPhotos extends ChangeNotifier{
  ...
  String _accessToken = "EAA9nZAM7qBEIBAGLAuidtRl1d3AIZA0AJLHnMIwjc3CBINbST105VuBAybskMaPzah0AHCqKJFK0Ff3sAZANj0aENDIzp2z2PfyLxHLZCsc2lbuabBbBgSh42OZCN6vIrNuArZAyVZCIYH3w02pEglUT2ZA5frieu9GFWkuhS5ft6KQyNZBeHeDyB7TRmXS6q4mkZD";
 
 Future fetchPhotos() async {
   http.Response response;
   response = await http.get("https://graph.facebook.com/v9.0/112387216836055/feed?fields=id%2Cmessage%2Cfull_picture&access_token=_pageAccessToken");
